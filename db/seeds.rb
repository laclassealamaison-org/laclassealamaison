...
Resource.create!([
                   { name: 'Lumni', url: 'https://www.lumni.fr/primaire/maternelle', classrooms: Classroom.where(name: 'Maternelle'), description: 'Lumni est une offre de 3000 contenus multimédias (vidéos, audios, articles, pistes pédagogiques) gratuits pour les élèves, parents, enseignants et médiateurs, qui permet un accès à la culture, au savoir et à la connaissance.' },
                   { name: 'Le Monde des Zibous', url: 'https://www.youtube.com/channel/UCcohFTzyHqEkehrvCXR6f9Q/', classrooms: Classroom.where(name: 'Maternelle'), description: "Bienvenue dans le Monde des Zibous, la chaîne préférée des tous-petits ... et des moins petits ! Dans le Monde des Zibous, on peut trouver des comptines françaises, des histoires merveilleuses mais aussi des vidéos ludiques et éducatives pour apprendre en chantant et en s'amusant !" },
                   { name: 'Le Monde des Titounis', url: 'https://www.youtube.com/user/ssebastienn/', classrooms: Classroom.where(name: 'Maternelle'), description: "Bienvenue sur la chaîne pour enfants : Monde des Titounis ! Ici, les petits enfants trouveront chaque semaine de nouvelles vidéos pour chanter (avec une sélection des meilleurs comptines et chansons en français et en anglais), apprendre le français (avec des vidéos éducatives pour apprendre l'alphabet, les chiffres, les couleurs etc...) et rêver (avec une sélection des meilleurs contes et histoires de Grimm, Perrault ou Andersen à écouter et à regarder en famille)." },
                   { name: 'Didou', url: 'https://www.youtube.com/user/DidouMillimages', classrooms: Classroom.where(name: 'Maternelle'), description: "Didou est un dessin-animé éducatif préscolaire qui apprend aux enfants à dessiner! Chaque semaine, les enfants découvrent un nouvel épisode et s'exercent au dessin et au coloriage. Ils apprendront aussi bien à dessiner des animaux, que des paysages ou des véhicules." },

                   { name: 'Méditation pour les enfants', url: 'https://www.youtube.com/playlist?list=PLqSk7Cu0HAF54zStfBWR2jGkGLco4dFTN', classrooms: ['Maternelle', 'CP', 'CE1', 'CE2', 'CM1', 'CM2' ], description: 'Playlist de vidéos de méditation pour les enfants à partir de 3 ans.' },
                   { name: 'C\'est Pas Sorcier', url: 'https://www.youtube.com/user/cestpassorcierftv', classrooms: ['CP', 'CE1', 'CE2', 'CM1', 'CM2'], description: "C'est pas sorcier, la chaîne officielle. La science évolue sans cesse, certaines données chiffrées peuvent avoir changé depuis la réalisation de cette émission, certaines découvertes ont pu être faites : comme tout journaliste multipliez vos sources d'information." },


                   { name: 'Lumni', url: 'https://www.lumni.fr/primaire/cp', classrooms: Classroom.where(name: 'CP'), description: 'Lumni est une offre de 3000 contenus multimédias (vidéos, audios, articles, pistes pédagogiques) gratuits pour les élèves, parents, enseignants et médiateurs, qui permet un accès à la culture, au savoir et à la connaissance.' },

                   { name: 'Lumni', url: 'https://www.lumni.fr/primaire/ce1', classrooms: Classroom.where(name: 'CE1'), description: 'Lumni est une offre de 3000 contenus multimédias (vidéos, audios, articles, pistes pédagogiques) gratuits pour les élèves, parents, enseignants et médiateurs, qui permet un accès à la culture, au savoir et à la connaissance.' },

                   { name: 'Lumni', url: 'https://www.lumni.fr/primaire/ce2', classrooms: Classroom.where(name: 'CE2'), description: 'Lumni est une offre de 3000 contenus multimédias (vidéos, audios, articles, pistes pédagogiques) gratuits pour les élèves, parents, enseignants et médiateurs, qui permet un accès à la culture, au savoir et à la connaissance.' },

                   { name: 'Lumni', url: 'https://www.lumni.fr/primaire/cm1', classrooms: Classroom.where(name: 'CM1'), description: 'Lumni est une offre de 3000 contenus multimédias (vidéos, audios, articles, pistes pédagogiques) gratuits pour les élèves, parents, enseignants et médiateurs, qui permet un accès à la culture, au savoir et à la connaissance.' },

                   { name: 'Lumni', url: 'https://www.lumni.fr/primaire/cm2', classrooms: Classroom.where(name: 'CM2'), description: 'Lumni est une offre de 3000 contenus multimédias (vidéos, audios, articles, pistes pédagogiques) gratuits pour les élèves, parents, enseignants et médiateurs, qui permet un accès à la culture, au savoir et à la connaissance.' },
                 ])
puts '...ok'
