...
Resource.create!([
  ...
  { name: 'Médiation pour les enfants', url: 'https://www.youtube.com/playlist?list=PLqSk7Cu0HAF54zStfBWR2jGkGLco4dFTN', classroom: Classroom.find_by(name: "CP"), description: 'Playlist de vidéos de méditation pour les enfants à partir de 4 ans.'},
