...
Resource.create!([
  ...
  { name: 'Médiation pour les enfants', url: 'https://www.youtube.com/playlist?list=PLqSk7Cu0HAF54zStfBWR2jGkGLco4dFTN', classroom: Classroom.find_by(name: "Maternelle"), description: 'Playlist de vidéos de méditation pour les enfants à partir de 3 ans.'},
  ...
  { name: 'Médiation pour les enfants', url: 'https://www.youtube.com/playlist?list=PLqSk7Cu0HAF54zStfBWR2jGkGLco4dFTN', classroom: Classroom.find_by(name: "CP"), description: 'Playlist de vidéos de méditation pour les enfants à partir de 3 ans.'},
  ...
  { name: 'Maxicours', url: 'https://www.maxicours.com/se/ce1/', classroom: Classroom.find_by(name: "CE1"), description: "Maxicours.com est une plateforme d’accompagnement scolaire en ligne fondée en 2000 par Benjamin Magnard, fils de Roger Magnard créateur des “Cahiers de Vacances”. Fort d’une expérience de 20 ans dans ce domaine, Maxicours est devenu la référence du soutien scolaire pour toutes les classes, avec un service de professeurs en ligne ainsi que des espaces de préparation aux examens."},
  { name: 'Médiation pour les enfants', url: 'https://www.youtube.com/playlist?list=PLqSk7Cu0HAF54zStfBWR2jGkGLco4dFTN', classroom: Classroom.find_by(name: "CE1"), description: 'Playlist de vidéos de méditation pour les enfants à partir de 3 ans.'},
  ...
  { name: 'Maxicours', url: 'https://www.maxicours.com/se/ce2/', classroom: Classroom.find_by(name: "CE2"), description: "Maxicours.com est une plateforme d’accompagnement scolaire en ligne fondée en 2000 par Benjamin Magnard, fils de Roger Magnard créateur des “Cahiers de Vacances”. Fort d’une expérience de 20 ans dans ce domaine, Maxicours est devenu la référence du soutien scolaire pour toutes les classes, avec un service de professeurs en ligne ainsi que des espaces de préparation aux examens."},
  { name: 'Médiation pour les enfants', url: 'https://www.youtube.com/playlist?list=PLqSk7Cu0HAF54zStfBWR2jGkGLco4dFTN', classroom: Classroom.find_by(name: "CE2"), description: 'Playlist de vidéos de méditation pour les enfants à partir de 3 ans.'},
  ...
  { name: 'Maxicours', url: 'https://www.maxicours.com/se/cm1/', classroom: Classroom.find_by(name: "CM1"), description: "Maxicours.com est une plateforme d’accompagnement scolaire en ligne fondée en 2000 par Benjamin Magnard, fils de Roger Magnard créateur des “Cahiers de Vacances”. Fort d’une expérience de 20 ans dans ce domaine, Maxicours est devenu la référence du soutien scolaire pour toutes les classes, avec un service de professeurs en ligne ainsi que des espaces de préparation aux examens."},
  { name: 'Médiation pour les enfants', url: 'https://www.youtube.com/playlist?list=PLqSk7Cu0HAF54zStfBWR2jGkGLco4dFTN', classroom: Classroom.find_by(name: "CM1"), description: 'Playlist de vidéos de méditation pour les enfants à partir de 3 ans.'},
  ...
  { name: 'Maxicours', url: 'https://www.maxicours.com/se/cm2/', classroom: Classroom.find_by(name: "CM2"), description: "Maxicours.com est une plateforme d’accompagnement scolaire en ligne fondée en 2000 par Benjamin Magnard, fils de Roger Magnard créateur des “Cahiers de Vacances”. Fort d’une expérience de 20 ans dans ce domaine, Maxicours est devenu la référence du soutien scolaire pour toutes les classes, avec un service de professeurs en ligne ainsi que des espaces de préparation aux examens."},
  { name: 'Médiation pour les enfants', url: 'https://www.youtube.com/playlist?list=PLqSk7Cu0HAF54zStfBWR2jGkGLco4dFTN', classroom: Classroom.find_by(name: "CM2"), description: 'Playlist de vidéos de méditation pour les enfants à partir de 3 ans.'}
])
puts "...ok"
